...
eps(x)=eps8 + (epss-eps8)*omega*omega/(omega*omega+2*{0,1}*(2*pi*x)*delta-(2*pi*x)**2)
c(x)=c0/sqrt(real(eps(x)))
k(x)=x/c(x)
refl(x)=abs((sqrt(eps(x))-1)/(sqrt(eps(x))+1))
De(x)=x*1e-9
GNUTERM = "aqua"
eps8 = 1.5
epss = 3.0
omega = 125663706143.592
delta = 12566370614.3592
GPFUN_eps = "eps(x)=eps8 + (epss-eps8)*omega*omega/(omega*omega+2*{0,1}*(2*pi*x)*delta-(2*pi*x)**2)"
c0 = 299800000.0
GPFUN_c = "c(x)=c0/sqrt(real(eps(x)))"
GPFUN_k = "k(x)=x/c(x)"
GPFUN_refl = "refl(x)=abs((sqrt(eps(x))-1)/(sqrt(eps(x))+1))"
mu0 = 1.25663706143592e-06
eps0 = 1.39812694947167e-23
x = 0.0
